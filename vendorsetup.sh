...
git clone https://github.com/Matrixx-Devices/android_vendor_xiaomi_peridot -b 15 vendor/xiaomi/peridot
git clone https://github.com/Matrixx-Devices/android_device_xiaomi_peridot-kernel -b 14 device/xiaomi/peridot-kernel
...
git clone https://github.com/Matrixx-Devices/android_vendor_lineage-priv vendor/lineage-priv
